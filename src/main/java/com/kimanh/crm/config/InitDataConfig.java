...
public class InitDataConfig {
    ...
    private void seedSaleAccount(String fullName, Set<String> existingNormalizedNames) {
        ...
        // Không tự tạo lại tài khoản mà admin đã chủ động xóa ở "Quản lý Tài khoản" — nếu không,
        // account sẽ tái xuất hiện ở mỗi lần restart backend miễn là còn khách hàng cũ gán Sale=tên đó.
        if (removedSaleNameRepository.existsByFullName(normalized)) return;
    ...
    private void runMigrations() {
        String[] migrations = {
            ...
            "CREATE TABLE IF NOT EXISTS removed_sale_names (" +
